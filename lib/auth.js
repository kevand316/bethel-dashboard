...
(function () {
  ...
  async function logout() {
    // Drop the stored Google Drive credential first. Leaving a live token in
    // localStorage after an explicit sign-out would let the next person at this
    // machine reach the intake records without the dashboard password.
    if (window.drive) window.drive.forgetToken();
